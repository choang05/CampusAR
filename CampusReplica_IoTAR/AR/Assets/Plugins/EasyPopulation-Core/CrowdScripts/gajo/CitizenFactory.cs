...
namespace Crowd {
    ...
    public class CitizenFactory : Singleton<CitizenFactory>
    {
     ...
     public static int qtGajosBeginingPopulation = 0;
        ...
        public static Transform PopulationManagerTr;
    ...
    public void start(){
            PopulationManagerTr = GameObject.FindGameObjectWithTag("PopulationManager").transform;
            begin();
   ...
   void begin(){
     ...
     IEnumerator  GenerateAdultPopulation()
        ...
        public static void criaGajo_Producao(int i, float radius)
        {
            ...
            if(anchors_Production.Count>0)
            {
               ...
               Vector3 position = v3GetValidCoordinate(anchors_Production[aux].transform.position, radius);
                ...
                GameObject go = (GameObject)Instantiate(template, position, Quaternion.identity, PopulationManagerTr);
                ...
                if (Random.Range(0, 100.0f) > 97.5f)//02.5% chances
                {
                    ...
                    if (template != null)
                    {
                        GameObject go2 = (GameObject)Instantiate(template, position + Vector3.right, Quaternion.identity, PopulationManagerTr);
                ...
                if (listaTemplates_Children_Production.Count > 0)
                {
                    ...
                    if (template != null)
                    {
                        ...
                        {
                            GameObject go1 = (GameObject)Instantiate(template, position + Vector3.right, Quaternion.identity, PopulationManagerTr);
                ...
                else
                {
                    ...
                    {                       
                        if (item.posicaoInicial && item.boneco)
                        {
                            ...
                            GameObject go = (GameObject)Instantiate(prefab, pos, Quaternion.identity, PopulationManagerTr);
        ...
        public static void createGajo(int[] dna)
        {
            ...
            GameObject go = (GameObject)Instantiate(prefab, position, Quaternion.identity, PopulationManagerTr);
